...
real_data_memmap_path = '/Users/sofie/Desktop/Projects/Dissertation_Program/dat_files/real_data_run2.dat'
imag_data_memmap_path = '/Users/sofie/Desktop/Projects/Dissertation_Program/dat_files/imag_data_run2.dat'
ellipticity_memmap_path = '/Users/sofie/Desktop/Projects/Dissertation_Program/dat_files/ellipticity_run2.dat'
...
def normalize_data(data):
    ...
    if data_max == data_min:
        return np.zeros_like(data)  # Avoid division by zero by returning zeros if min == max
        ...
        for nested_dict in outer_dict.values():
            ...
            if fft_data is not None and ellipticity_value is not None:
                ...
                if ellipticity_value is not None:
                    # print(f"ellipticity_value shape: {np.shape(ellipticity_value)}")
...
prediction_logger = prediction_logger_callback(
    ...
    output_csv_path='/Users/sofie/Desktop/Projects/Dissertation_Program/predictions_run2/preds_run2_epoch{epoch}_{type}.csv'
)
...
#     epochs=2,
#     callbacks=[checkpoint_callback, prediction_logger]
# )

# pdb.set_trace()

# correct_labels = np.loadtxt('list of labels')
# train_dataset.labels = correct_labels
...
training_results_csv_file_path = '/Users/sofie/Desktop/Projects/Dissertation_Program/training_history_run2.csv'
...
log_predictions(model, test_dataset, 'test_predictions_run2.csv')
...
evaluation_csv_file_path = '/Users/sofie/Desktop/Projects/Dissertation_Program/evaluation_results_run2.csv'
